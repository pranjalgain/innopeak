...
// @ts-ignore
import type { GetPromptStatsBatchDto } from '../models';
// @ts-ignore
import type { PromptListResponseDto } from '../models';
// @ts-ignore
import type { PromptStatsBatchResponseDto } from '../models';
// @ts-ignore
import type { PromptVersionStatsResponseDto } from '../models';
// @ts-ignore
...
export const PromptsApiAxiosParamCreator = function (
  ...
  return {
    ...
    /**
     * The batch counterpart to GET /v1/prompts/:promptId/stats — one grouped query for every pair given, instead of one request per prompt. A pair with no matching data (or that does not exist) comes back with all-zero/null stats rather than an error.
     * @summary Get prompt analytics for many (promptId, version) pairs
     * @param {GetPromptStatsBatchDto} getPromptStatsBatchDto
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    promptsControllerGetVersionStatsBatchV1: async (
      getPromptStatsBatchDto: GetPromptStatsBatchDto,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'getPromptStatsBatchDto' is not null or undefined
      assertParamExists(
        'promptsControllerGetVersionStatsBatchV1',
        'getPromptStatsBatchDto',
        getPromptStatsBatchDto,
      );
      const localVarPath = `/v1/prompts/stats/batch`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    /**
     * Aggregates review_responses generated by a prompt into approval/edit/rejection counts and average decision time. Omitting the version query param aggregates every version of the prompt; ?version=N scopes to one. Computed server-side from a single query, rather than the frontend fetching full review rows to compute the same numbers.
     * @summary Get prompt analytics
     * @param {string} promptId
     * @param {number} [version] Scopes the aggregate to one prompt version. Omit to aggregate across every version.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    promptsControllerGetVersionStatsV1: async (
      promptId: string,
      version?: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'promptId' is not null or undefined
      assertParamExists(
        'promptsControllerGetVersionStatsV1',
        'promptId',
        promptId,
      );
      const localVarPath = `/v1/prompts/{promptId}/stats`.replace(
        '{promptId}',
        encodeURIComponent(String(promptId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const PromptsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async promptsControllerGetVersionStatsBatchV1(
      getPromptStatsBatchDto: GetPromptStatsBatchDto,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PromptStatsBatchResponseDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.promptsControllerGetVersionStatsBatchV1(
          getPromptStatsBatchDto,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap[
          'PromptsApi.promptsControllerGetVersionStatsBatchV1'
     ...
     * @throws {RequiredError}
     */
    async promptsControllerGetVersionStatsV1(
      promptId: string,
      version?: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PromptVersionStatsResponseDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.promptsControllerGetVersionStatsV1(
          promptId,
          version,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PromptsApi.promptsControllerGetVersionStatsV1']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const PromptsApiFactory = function (
  ...
  return {
     ...
     * The batch counterpart to GET /v1/prompts/:promptId/stats — one grouped query for every pair given, instead of one request per prompt. A pair with no matching data (or that does not exist) comes back with all-zero/null stats rather than an error.
     * @summary Get prompt analytics for many (promptId, version) pairs
     * @param {PromptsApiPromptsControllerGetVersionStatsBatchV1Request} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    promptsControllerGetVersionStatsBatchV1(
      requestParameters: PromptsApiPromptsControllerGetVersionStatsBatchV1Request,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PromptStatsBatchResponseDto> {
      return localVarFp
        .promptsControllerGetVersionStatsBatchV1(
          requestParameters.getPromptStatsBatchDto,
          options,
        )
        .then((request) => request(axios, basePath));
    },
     ...
     * Aggregates review_responses generated by a prompt into approval/edit/rejection counts and average decision time. Omitting the version query param aggregates every version of the prompt; ?version=N scopes to one. Computed server-side from a single query, rather than the frontend fetching full review rows to compute the same numbers.
     * @summary Get prompt analytics
     * @param {PromptsApiPromptsControllerGetVersionStatsV1Request} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    promptsControllerGetVersionStatsV1(
      requestParameters: PromptsApiPromptsControllerGetVersionStatsV1Request,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PromptVersionStatsResponseDto> {
      return localVarFp
        .promptsControllerGetVersionStatsV1(
...
/**
 * Request parameters for promptsControllerGetVersionStatsBatchV1 operation in PromptsApi.
 */
export interface PromptsApiPromptsControllerGetVersionStatsBatchV1Request {
  readonly getPromptStatsBatchDto: GetPromptStatsBatchDto;
}

/**
 * Request parameters for promptsControllerGetVersionStatsV1 operation in PromptsApi.
 */
export interface PromptsApiPromptsControllerGetVersionStatsV1Request {
  readonly promptId: string;

  /**
   * Scopes the aggregate to one prompt version. Omit to aggregate across every version.
   */
...
export class PromptsApi extends BaseAPI implements PromptsApiInterface {
   ...
   * @throws {RequiredError}
   */
  public promptsControllerGetVersionStatsBatchV1(
    requestParameters: PromptsApiPromptsControllerGetVersionStatsBatchV1Request,
    options?: RawAxiosRequestConfig,
  ) {
    return PromptsApiFp(this.configuration)
   ...
   * @throws {RequiredError}
   */
  public promptsControllerGetVersionStatsV1(
    requestParameters: PromptsApiPromptsControllerGetVersionStatsV1Request,
    options?: RawAxiosRequestConfig,
  ) {
    return PromptsApiFp(this.configuration)
