...
export const MOCK_REVIEWS: Review[] = [
  ...
  {
    id: "rev_11",
    reviewerName: "Priya Chandran",
    rating: 5,
    reviewText:
      "Took my parents here for their anniversary and the whole team went out of their way to make it special. Complimentary dessert, handwritten card, the works.",
    reviewedAt: "2026-07-30T19:20:00Z",
    classification: "auto_reply_candidate",
    escalationReason: null,
    status: "responded",
    replyDrafts: [
      {
        ...
        label: "A",
        content:
          "Priya, this means so much — thank you for trusting us with your parents' anniversary. We'll pass your kind words along to the whole team.",
        originalContent:
          "Priya, this means so much — thank you for trusting us with your parents' anniversary. We'll pass your kind words along to the whole team.",
        status: "approved",
        promptId: "prompt_positive",
        promptVersion: 1,
        createdAt: "2026-07-30T19:25:00Z",
      ...
      },
      {
        ...
        label: "B",
        content:
          "Thank you, Priya! Celebrating your parents' anniversary with us was our pleasure — so glad the little touches landed.",
        originalContent:
          "Thank you, Priya! Celebrating your parents' anniversary with us was our pleasure — so glad the little touches landed.",
        status: "superseded",
        promptId: "prompt_positive",
  ...
  {
    id: "rev_12",
    reviewerName: "Marcus Delgado",
    rating: 2,
    reviewText:
      "Table was sticky, silverware had water spots, and it took two flags-down to get a check. Food itself was decent but the service let it down.",
    reviewedAt: "2026-07-22T20:45:00Z",
    classification: "escalated",
    escalationReason: "low_rating",
    status: "in_review",
    replyDrafts: [
      {
        ...
        label: "A",
        content:
          "Marcus, I'm sorry the table and silverware weren't up to standard, and that getting your check took too long — that's on us. I'd like to make this right; please reach out directly.",
        originalContent:
          "Marcus, I'm sorry the table and silverware weren't up to standard, and that getting your check took too long — that's on us. I'd like to make this right; please reach out directly.",
        status: "pending_approval",
        promptId: "prompt_negative",
      ...
      },
      {
        ...
        label: "B",
        content:
          "Thank you for the honest feedback, Marcus. A sticky table and slow checkout aren't the standard we hold ourselves to. We'd welcome the chance to do better next time.",
        originalContent:
          "Thank you for the honest feedback, Marcus. A sticky table and slow checkout aren't the standard we hold ourselves to. We'd welcome the chance to do better next time.",
        status: "pending_approval",
        promptId: "prompt_negative",
  ...
  {
    id: "rev_13",
    reviewerName: "Lena Vogt",
    rating: 4,
    reviewText:
      "Great spot for a working lunch — quick service, quiet enough to hear each other, and the fish tacos were excellent.",
    reviewedAt: "2026-08-05T13:10:00Z",
    classification: "pending_classification",
    escalationReason: null,
    status: "new",
    replyDrafts: [],
  },
  {
    ...
    rating: 1,
    reviewText:
      "Found a hair in my food and when I brought it up the manager acted like I was making it up. Left without eating.",
    reviewedAt: "2026-08-12T21:35:00Z",
    classification: "escalated",
    escalationReason: "low_rating",
    status: "new",
    replyDrafts: [],
  ...
  {
    id: "rev_15",
    reviewerName: "Iris Novak",
    rating: 3,
    reviewText:
      "Middle-of-the-road experience. The view from the patio is the real draw; the menu itself is fine but nothing memorable.",
    reviewedAt: "2026-06-27T18:00:00Z",
    classification: "unclassified",
    escalationReason: null,
    status: "dismissed",
    replyDrafts: [],
